# Ejercicios Introducción a Python: Enunciados1Ejercicios Introducción a
# Python: Enunciados
...
# Ejercicios Introducción a Python: Enunciados3Crea un programa que cuente la cantidad de palabras en una oración ingresada por
# el usuario.
